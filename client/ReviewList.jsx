  ...
  render() {
    return (
      <div className="review-list">
        <div onClick={this.toggleReadMore}>{this.state.reviews.length} reviews ({this.state.rating.toFixed(2)}/5)</div>
        <div>
